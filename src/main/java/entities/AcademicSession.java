...
public class AcademicSession {
    ...
    @Column(name = "active")
    private Boolean active = false;         // exactly one session is "active" at a time

    @Column(name = "closed")
    private Boolean closed = false;         // true once the session is fully archived
    ...
    public boolean isClosed() { return closed != null ? closed : false; }
