...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (saveBtn) {
        saveBtn.addEventListener('click', function () {
            ...
            // Include constraint priority radio buttons
            document.querySelectorAll('input[name^="constraint_priority_"]:checked').forEach(function(inp) {
                fd.append(inp.name, inp.value);
            });
            // Include hidden priority inputs (locked constraints)
            document.querySelectorAll('input[type="hidden"][name^="constraint_priority_"]').forEach(function(inp) {
                fd.append(inp.name, inp.value);
            });
    ...
    var autofilled = ${configSaved ? 'true' : 'false'};
