    ...
    <div class="card p-3 p-md-4">
        ...
        <form action="saveBranding.do" method="post" enctype="multipart/form-data">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    <label class="form-label small fw-semibold">Titre PDF (Affectation)</label>
                    <input type="text" name="documentTitleAffectation" class="form-control"
                           value="${fn:escapeXml(appSettings.documentTitleAffectation)}"
                           placeholder="Ex: Affectation des encadrants">
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label small fw-semibold">Titre PDF (Planning)</label>
                    <input type="text" name="documentTitlePlanning" class="form-control"
                           value="${fn:escapeXml(appSettings.documentTitlePlanning)}"
                           placeholder="Ex: Planning des soutenances">
                </div>
